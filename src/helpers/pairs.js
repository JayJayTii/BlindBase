...
//Some letter pairs are impossible on a Rubik's Cube, so we need to calculate the possible ones.
//Possible pairs have been pre-calculated into arrays with the functions below

//All pairs for each piece type
...
function generateCornerPairs() {
    ...
    //This output will be copied into the allCornerPairs array above
    let pairStr = ""
    pairStr += ("[")
...
function generateEdgePairs() {
    ...
    //This output will be copied into the allEdgePairs array above
    let pairStr = ""
    pairStr += ("[")
    for (let pair of pairs) {
        pairStr += (`  "${pair}",`)
...
//Gets the union of the possible corner and edge pair arrays to get the allPossiblePairs array
...
function generateAllLetterPairs() {
    ...
    //This output will be copied into the allLetterPairs array above
    let pairStr = ""
    pairStr += ("[")
    for (let pair of pairs) {
        pairStr += (`  "${pair}",`)
