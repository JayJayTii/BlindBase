...
export function isPossiblePair(pieceType, pair, buffer) {
    ...
    switch (pieceType) {
        case 1:
            ...
            return !(adjacentCornerStickers[letters[buffer]].includes(pair[0]) || adjacentCornerStickers[letters[buffer]].includes(pair[1])
                        || adjacentCornerStickers[pair[0]].includes(pair[1]))
        case 2:
            //Skip if contains buffer sticker
            //Skip if second letter is on first letter's cubie
            return !(adjacentEdgeStickers[letters[buffer]].includes(pair[0])
                || adjacentEdgeStickers[letters[buffer]].includes(pair[1])
