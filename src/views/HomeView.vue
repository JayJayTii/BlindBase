...
<template>
    <div style="text-align:center; display: flex; flex-direction: column; gap: 20px;">
        ...
        <el-text type="primary" style="font-size: 5rem; font-weight: 600;">
            BlindBase
        </el-text>
        <el-text style="font-size: 1.5rem; width: min(700px, 100%)">
            Blindbase.net is a website that helps you learn the 3-Style method for the Rubik's Cube blindfolded. There are 6 tools you can use to accelerate the process:
        </el-text>
        ...
        <div id="home-view-cards">
            <el-card shadow="hover" body-style="padding: 0px;">
                <div slot="header" class="el-card__header">
                    Sheets <el-button @click="router.push('/sheets')" type="primary">></el-button>
                </div>
            ...
            <el-card shadow="hover" body-style="padding: 0px;">
                <div slot="header" class="el-card__header">
                    Flashcards <el-button @click="router.push('/cards')" type="primary">></el-button>
                </div>
                <div class="home-card-body">
            ...
            <el-card shadow="hover" body-style="padding: 0px;">
                <div slot="header" class="el-card__header">
                    Memo <el-button @click="router.push('/memo')" type="primary">></el-button>
                </div>
                <div class="home-card-body">
            ...
            <el-card shadow="hover" body-style="padding: 0px;">
                <div slot="header" class="el-card__header">
                    Exec <el-button @click="router.push('/exec')" type="primary">></el-button>
                </div>
                <div class="home-card-body">
            ...
            <el-card shadow="hover" body-style="padding: 0px;">
                <div slot="header" class="el-card__header">
                    Timer <el-button @click="router.push('/timer')" type="primary">></el-button>
                </div>
                <div class="home-card-body">
            ...
            <el-card shadow="hover" body-style="padding: 0px;">
                <div slot="header" class="el-card__header">
                    Reconstructions <el-button @click="router.push('/recons')" type="primary">></el-button>
                </div>
                <div class="home-card-body">
